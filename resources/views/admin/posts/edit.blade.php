                    ...
                    <form role="form" action={{route('admin.posts.update' ,$request->id)}} method="post" enctype="multipart/form-data">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" value="{{$request->title}}" name="title" class="form-control" id="Name" placeholder="Enter Name">
                        </div>
                        <div class="form-group">
                          <label for="description">Description</label>
                         <textarea name="description" id="description" class="form-control" cols="30" rows="10">{{$request->description}}</textarea>
                        </div>
                        <div class="form-group">
